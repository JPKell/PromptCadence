...
**Status:** `1.3.3` in the repository (not yet tagged; `pip index versions promptcadence` says what PyPI serves). Every phase of the development plan is built and gated: planning with
