...
**Status:** `1.3.2` in the repository (tagged `v1.3.2`; `pip index versions promptcadence` says what PyPI serves). Every phase of the development plan is built and gated: planning with
